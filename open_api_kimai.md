{
    ...
    "info": {
        "title": "Kimai - API",
        "description": "JSON API for the Kimai time-tracking software. Read our [API documentation](https://www.kimai.org/documentation/rest-api.html) and download the [Open API definition](doc.json) to import into your API client.\n",
        "version": "1.0"
    },
    "paths": {
        ...
        "/api/activities/{id}": {
            ...
            "delete": {
                ...
                "operationId": "delete_delete_activity",
                "parameters": [
                    {
                        "name": "id",
                        "in": "path",
        ...
        "/api/config/colors": {
            "get": {
                ...
                "summary": "Returns the configured color codes and names",
        ...
        "/api/invoices": {
            "get": {
                ...
                "summary": "Returns a paginated collection of invoices.",
                "description": "Needs permission: view_invoice",
                "operationId": "get_get_invoices",
                "parameters": [
                    {
                        "name": "begin",
                        "in": "query",
        ...
        "/api/projects/{id}": {
            ...
            "delete": {
                ...
                "operationId": "delete_delete_project",
                "parameters": [
                    {
                        "name": "id",
                        "in": "path",
        ...
        "/api/tags": {
            "get": {
                ...
                "summary": "Deprecated: Fetch tags by filter as string collection",
        ...
        "/api/tags/find": {
            "get": {
                ...
                "summary": "Fetch tags by filter (as full entities)",
                "operationId": "get_get_tags_full",
                "parameters": [
                    {
                        "name": "name",
                        "in": "query",
        ...
        "/api/users/api-token/{id}": {
            "delete": {
                ...
                "summary": "Delete an API token for the current user",
                "operationId": "delete_delete_api_token",
                "parameters": [
                    {
                        "name": "id",
                        "in": "path",
